...
using Prism.Mvvm;
using StefanAlpers.ActivityTracker.CrossCutting.DataClasses;
using StefanAlpers.ActivityTracker.UI.ActivityTrackerDesktop.Attributes;

namespace StefanAlpers.ActivityTracker.UI.ActivityTrackerDesktop.ViewModels
{
    internal class ActivitiesViewModel : BindableBase, IDataErrorInfo
    {
        ...
        private Activity _SelectedRecord;
        ...
        {
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 8, 0, 0), "541", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 8, 20, 0), "541", new TimeSpan(0, 28, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 8, 40, 0), "541", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 9, 0, 0), "PAUSE", new TimeSpan(0, 20, 0), ActivityType.BREAK));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 9, 20, 0), "111", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 9, 40, 0), "111", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 10, 0, 0), "541", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 10, 20, 0), "134", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 10, 40, 0), "134", new TimeSpan(0, 30, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 11, 20, 0), "111", new TimeSpan(0, 40, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 12, 0, 0), "PAUSE", new TimeSpan(0, 40, 0), ActivityType.BREAK));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 12, 20, 0), "134", new TimeSpan(0, 20, 0)));
            _Activities.Add(new Activity(new DateTime(2019, 4, 21, 12, 40, 0), "134", new TimeSpan(0, 20, 0)));
        ...
        private void ExecuteAddBreak()
        {
            ...
            Activities.Add(new Activity(_TimeStamp, "PAUSE", duration, ActivityType.BREAK));
        ...
        private void InsertActivity(string activityText)
        {
            ...
            Activities.Add(new Activity(_TimeStamp, activityText, duration));
        }
        ...
        public ObservableCollection<Activity> Activities { get => _Activities; }
        ...
        /// </summary>
        public Activity SelectedRecord
        {
            get => _SelectedRecord;
            set
            {
